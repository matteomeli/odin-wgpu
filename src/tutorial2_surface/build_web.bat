...
call odin.exe build . -target:js_wasm32 -out:web/program.wasm -o:size -extra-linker-flags:"--export-table --import-memory --initial-memory=%INITIAL_MEMORY_BYTES% --max-memory=%MAX_MEMORY_BYTES%"
if errorlevel 1 (
